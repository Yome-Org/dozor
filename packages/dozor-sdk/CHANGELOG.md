...
### Changed
- Updated test tooling to `vitest@4` and `@vitest/coverage-v8@4`.
- Added workflow run summaries for CI, integration, and publish pipelines.
- Added package metadata required for npm provenance publishing.
